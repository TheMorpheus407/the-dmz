...
```html
<header role="banner">          <!-- Top bar: status, threat level, funds -->
...
@media (pointer: fine) and (hover: hover) {
  .interactive { min-height: 32px; }
  .tooltip { display: block; } /* on hover */
}

/* Coarse pointer (touch) */
@media (pointer: coarse) {
  .interactive { min-height: 48px; min-width: 48px; }
  .tooltip { display: none; } /* use long-press or info button instead */
}
```
...
*Document prepared for The DMZ: Archive Gate development team. All specifications are subject to iteration based on user testing and technical feasibility assessment.*

*This document should be reviewed alongside:*
- *BRD-01: Project Overview*
- *BRD-02: Game Design Document*
- *BRD-03: Technical Architecture*
- *BRD-14: Testing & QA Strategy*
