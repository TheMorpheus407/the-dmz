...
export const ErrorCodes = {
  ...
  SSO_JWKS_FETCH_FAILED: 'SSO_JWKS_FETCH_FAILED',
  SSO_TOKEN_EARLY: 'SSO_TOKEN_EARLY',
  SSO_ISSUER_MISMATCH: 'SSO_ISSUER_MISMATCH',
  SSO_AUDIENCE_MISMATCH: 'SSO_AUDIENCE_MISMATCH',
...
export const errorCodeMetadata: Record<ErrorCode, ErrorCodeMetadata> = {
  ...
  [ErrorCodes.SSO_TOKEN_EXCHANGE_FAILED]: {
    category: ErrorCodeCategory.AUTHENTICATION,
    retryable: false,
    messageKey: 'errors.sso.tokenExchangeFailed',
  },
  [ErrorCodes.SSO_USERINFO_FAILED]: {
    category: ErrorCodeCategory.NETWORK,
    retryable: true,
    messageKey: 'errors.sso.userinfoFailed',
  },
  [ErrorCodes.SSO_JWKS_FETCH_FAILED]: {
    category: ErrorCodeCategory.NETWORK,
    retryable: true,
    messageKey: 'errors.sso.jwksFetchFailed',
  },
  [ErrorCodes.SSO_TOKEN_EARLY]: {
    category: ErrorCodeCategory.AUTHENTICATION,
    retryable: false,
    messageKey: 'errors.sso.tokenEarly',
  },
  [ErrorCodes.SSO_ISSUER_MISMATCH]: {
    category: ErrorCodeCategory.AUTHENTICATION,
    retryable: false,
    messageKey: 'errors.sso.issuerMismatch',
  },
  [ErrorCodes.SSO_AUDIENCE_MISMATCH]: {
    category: ErrorCodeCategory.AUTHENTICATION,
    retryable: false,
    messageKey: 'errors.sso.audienceMismatch',
  },
