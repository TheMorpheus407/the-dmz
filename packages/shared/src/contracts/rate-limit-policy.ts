...
export const m1RateLimitPolicyManifest: M1RateLimitPolicyManifest = {
  ...
  routes: [
    ...
    },
    {
      ...
      exempt: false,
      bucketKey: 'tenant',
      rationale: 'Game action limit for fair resource allocation',
    },
    {
      route: '/game/session',
      method: 'GET',
    ...
    },
    {
      ...
      exempt: false,
      bucketKey: 'tenant',
      rationale: 'Content query endpoint',
    },
    {
      ...
      exempt: false,
      bucketKey: 'tenant',
      rationale: 'Webhook management limit',
    },
    {
      route: '/webhooks/subscriptions',
      method: 'GET',
      ...
      exempt: false,
      bucketKey: 'tenant',
      rationale: 'Webhook listing - protected read with moderate limit',
    },
    {
      route: '/webhooks/subscriptions/:subscriptionId',
      method: 'GET',
      category: RateLimitCategory.PROTECTED_READ,
      max: 60,
      windowMs: 60_000,
      exempt: false,
      bucketKey: 'tenant',
      rationale: 'Webhook retrieval - protected read with moderate limit',
    },
    {
      route: '/webhooks/subscriptions/:subscriptionId',
      method: 'PATCH',
      ...
      exempt: false,
      bucketKey: 'tenant',
      rationale: 'Webhook update - protected write operation',
    },
    {
      route: '/webhooks/subscriptions/:subscriptionId',
      method: 'DELETE',
      ...
      exempt: false,
      bucketKey: 'tenant',
      rationale: 'Webhook deletion - protected write operation',
    },
    {
      route: '/webhooks/subscriptions/:subscriptionId/test',
      method: 'POST',
      category: RateLimitCategory.PROTECTED_WRITE,
      max: 10,
      windowMs: 60_000,
      exempt: false,
      bucketKey: 'tenant',
      rationale: 'Webhook test - strict limit to prevent resource exhaustion',
    },
    {
      route: '/webhooks/subscriptions/:subscriptionId/rotate-secret',
      method: 'POST',
      category: RateLimitCategory.PROTECTED_WRITE,
      max: 10,
      windowMs: 60_000,
      exempt: false,
      bucketKey: 'tenant',
      rationale: 'Secret rotation - strict limit for security-sensitive operation',
    },
    {
      ...
      exempt: false,
      bucketKey: 'tenant',
      rationale: 'Webhook delivery listing - protected read with moderate limit',
    },
    {
      route: '/webhooks/deliveries/:deliveryId',
      method: 'GET',
      category: RateLimitCategory.PROTECTED_READ,
      max: 60,
      windowMs: 60_000,
      exempt: false,
      bucketKey: 'tenant',
      rationale: 'Webhook delivery retrieval - protected read with moderate limit',
    },
    {
      route: '/auth/sso/validation/preflight',
      method: 'GET',
      category: RateLimitCategory.PROTECTED_READ,
      max: 30,
      windowMs: 60_000,
      exempt: false,
      bucketKey: 'tenant',
      rationale: 'SSO preflight check - moderate limit to prevent reconnaissance',
    },
    {
      route: '/auth/sso/validation/run',
      method: 'POST',
      category: RateLimitCategory.PROTECTED_WRITE,
      max: 10,
      windowMs: 60_000,
      exempt: false,
      bucketKey: 'tenant',
      rationale: 'SSO validation execution - strict limit to prevent resource exhaustion',
    },
    {
      route: '/auth/scim/validation/run',
      method: 'POST',
      category: RateLimitCategory.PROTECTED_WRITE,
      max: 10,
      windowMs: 60_000,
      exempt: false,
      bucketKey: 'tenant',
      rationale: 'SCIM validation execution - strict limit',
    },
    {
      route: '/auth/sso/validation/summary',
      method: 'GET',
      category: RateLimitCategory.PROTECTED_READ,
      max: 50,
      windowMs: 60_000,
      exempt: false,
      bucketKey: 'tenant',
      rationale: 'SSO validation summary - standard protected read',
    },
    {
      route: '/auth/sso/activation',
      method: 'POST',
      category: RateLimitCategory.PROTECTED_WRITE,
      max: 5,
      windowMs: 300_000,
      exempt: false,
      bucketKey: 'tenant',
      rationale: 'SSO activation - very strict limit, admin operation',
    },
  ],
  exemptRoutes: [
    {
