...
export const m1ApiContractManifest = {
  ...
  endpoints: [
    ...
    },
    {
      ...
      requiresAuth: true,
      responseEnvelope: 'success' as const,
      responseSchemaRef: 'gameSessionBootstrapResponseSchema',
    },
    {
      path: '/game/session',
      method: 'GET' as const,
    ...
    {
      path: '/game/sessions/:sessionId/incidents',
      method: 'GET' as const,
      requiresAuth: true,
      responseEnvelope: 'success' as const,
      responseSchemaRef: 'incidentListResponseSchema',
    },
    {
      path: '/game/sessions/:sessionId/incidents/active',
      method: 'GET' as const,
      requiresAuth: true,
      responseEnvelope: 'success' as const,
      responseSchemaRef: 'incidentListResponseSchema',
    ...
    {
      path: '/game/sessions/:sessionId/incidents/:incidentId',
      method: 'GET' as const,
      requiresAuth: true,
      responseEnvelope: 'success' as const,
      responseSchemaRef: 'incidentSingleResponseSchema',
    },
    {
      ...
      requiresAuth: true,
      responseEnvelope: 'success' as const,
      responseSchemaRef: 'availableActionsResponseSchema',
    },
    {
      ...
      requiresAuth: true,
      responseEnvelope: 'success' as const,
      responseSchemaRef: 'incidentStatusUpdateResponseSchema',
    },
    {
      ...
      requiresAuth: true,
      responseEnvelope: 'success' as const,
      responseSchemaRef: 'incidentResponseActionResponseSchema',
    },
    {
      ...
      requiresAuth: true,
      responseEnvelope: 'success' as const,
      responseSchemaRef: 'incidentResolveResponseSchema',
    },
    {
      ...
      requiresAuth: true,
      responseEnvelope: 'success' as const,
      responseSchemaRef: 'postIncidentReviewResponseSchema',
    },
    {
      path: '/game/sessions/:sessionId/incidents/stats',
      method: 'GET' as const,
      requiresAuth: true,
      responseEnvelope: 'success' as const,
      responseSchemaRef: 'incidentStatsResponseSchema',
    },
  ],
} as const;
