...
export const EVENT_OWNERSHIP_MANIFEST: EventOwnershipManifest = {
  events: [
    ...
    {
      eventType: 'authz.permission.created',
      owningModule: 'auth',
      version: 1,
      requiredMetadata: [
        'eventId',
    ...
    {
      eventType: 'authz.permission.updated',
      owningModule: 'auth',
      version: 1,
      requiredMetadata: [
        'eventId',
    ...
    {
      eventType: 'authz.permission.deleted',
      owningModule: 'auth',
      version: 1,
      requiredMetadata: [
        'eventId',
    ...
    {
      eventType: 'authz.role.permission.granted',
      owningModule: 'auth',
      version: 1,
      requiredMetadata: [
        'eventId',
    ...
    {
      eventType: 'authz.role.permission.revoked',
      owningModule: 'auth',
      version: 1,
      requiredMetadata: [
        'eventId',
    ...
    {
      eventType: 'authz.policy.created',
      owningModule: 'auth',
      version: 1,
      requiredMetadata: [
        'eventId',
    ...
    {
      eventType: 'authz.policy.deleted',
      owningModule: 'auth',
      version: 1,
      requiredMetadata: [
        'eventId',
    ...
    {
      eventType: 'authz.tenant.attribute.changed',
      owningModule: 'auth',
      version: 1,
      requiredMetadata: [
        'eventId',
    ...
    {
      eventType: 'ai.safety.check.completed',
      owningModule: 'aiPipeline',
      version: 1,
      requiredMetadata: [
        'eventId',
    ...
    {
      eventType: 'coop.session.created',
    ...
    {
      eventType: 'coop.session.authority_transferred',
      owningModule: 'multiplayer',
      version: 1,
      requiredMetadata: [
        'eventId',
    ...
    {
      eventType: 'coop.session.proposal_submitted',
      owningModule: 'multiplayer',
      version: 1,
      requiredMetadata: [
        'eventId',
    ...
    {
      eventType: 'coop.session.proposal_confirmed',
      owningModule: 'multiplayer',
      version: 1,
      requiredMetadata: [
        'eventId',
    ...
    {
      eventType: 'coop.session.proposal_overridden',
      owningModule: 'multiplayer',
      version: 1,
      requiredMetadata: [
        'eventId',
    ...
    {
      eventType: 'coop.session.day_advanced',
      owningModule: 'multiplayer',
      version: 1,
      requiredMetadata: [
        'eventId',
