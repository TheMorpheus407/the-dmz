...
CREATE INDEX IF NOT EXISTS "compliance_snapshots_tenant_idx" ON compliance_snapshots USING btree ("tenant_id");
CREATE INDEX IF NOT EXISTS "compliance_snapshots_framework_idx" ON compliance_snapshots USING btree ("framework_id");
CREATE INDEX IF NOT EXISTS "compliance_snapshots_snapshot_date_idx" ON compliance_snapshots USING btree ("snapshot_date");
CREATE INDEX IF NOT EXISTS "compliance_snapshots_tenant_framework_idx" ON compliance_snapshots USING btree ("tenant_id", "framework_id");
-- Unique constraint for upsert operations on compliance snapshots
CREATE UNIQUE INDEX IF NOT EXISTS "compliance_snapshots_tenant_framework_unique_idx" ON compliance_snapshots ("tenant_id", "framework_id");
...
DO $$ BEGIN
    ALTER TABLE compliance_snapshots ADD CONSTRAINT "compliance_snapshots_tenant_id_tenants_tenant_id_fk" 
