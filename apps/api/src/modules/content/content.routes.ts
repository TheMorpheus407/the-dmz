...
export const registerContentRoutes = async (fastify: FastifyInstance): Promise<void> => {
  ...
  fastify.post(
    ...
    async (request, _reply) => {
      ...
      if (body.emailTemplateId) {
        await contentService.saveQualityScore(config, user.tenantId, {
          emailTemplateId: body.emailTemplateId,
  ...
  fastify.get(
    ...
    async (request, _reply) => {
      ...
      const score = await contentService.getQualityScoreByEmailId(config, user.tenantId, emailId);
      ...
      const flags = await contentService.getQualityFlagsByScoreId(config, user.tenantId, score.id);
  ...
  fastify.get(
    ...
    async (request, _reply) => {
      ...
      const stats = await contentService.getQualityStats(config, user.tenantId);
  ...
  fastify.get(
    ...
    async (request, _reply) => {
      ...
      const history = await contentService.getQualityHistoryByEmailId(
        config,
        user.tenantId,
        emailId,
        query.limit,
