...
describe('UserRepository DI Compliance', () => {
  ...
  describe('UserRepository.create()', () => {
    it('should throw TypeError when config is undefined', () => {
      ...
      expect(() => {
        UserRepository.create(undefined as unknown as AppConfig);
      }).toThrow(TypeError);
    });
    ...
    it('should throw TypeError when config is null', () => {
      ...
      expect(() => {
        UserRepository.create(null as unknown as AppConfig);
      }).toThrow(TypeError);
    });
    ...
    it('should create repository instance when valid config is provided', () => {
      ...
      const repository = UserRepository.create(mockConfig);
